...
public class ReadRetrieveReadChatService
{
        ...
        IComputerVisionService? visionService = null)
    {
        ...
        if (!string.IsNullOrEmpty(embeddingModelName))
        {
            ...
            #pragma warning disable SKEXP0010 // Suppress warning about evaluation purposes only    
            kernelBuilder = kernelBuilder.AddAzureOpenAITextEmbeddingGeneration(deployedModelName, endpoint, apiKey);
...
Don't put your answer between ```json and ```, return the json string directly. e.g {{""answer"": ""I don't know"", ""thoughts"": ""I don't know""}}";
            ...
            var imageUrls = images.Select(x => x.Url).ToArray();
